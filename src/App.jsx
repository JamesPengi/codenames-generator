...
export default class App extends Component {
  state = {
    gameTable: [],
    cards: ['red1', 'red2', 'red3', 'red4', 'red5', 'red6', 'red7', 'red8', 'blue1', 'blue2', 'blue3', 'blue4', 'blue5', 'blue6', 'blue7', 'blue8', 'black1', 'white1', 'white2', 'white3', 'white4', 'white5', 'white6', 'white7', 'wildcard1'],
  }

  _generateTables() {
    var usingCards = this.state.cards
    var gameTable = []
  ...
  render() {
    ...
    return (
      <div className="App">
          <button onClick={() => this._generateTables()}>Generate Table</button>
